...
extern uint32_t llc_core_access[NUM_CPUS];
extern uint32_t llc_core_miss[NUM_CPUS];
extern uint32_t no_sets[NUM_CPUS];
extern uint32_t selfevic;
...
//	mshr_full = 0;
    ...
    uint32_t get_set(uint64_t address, uint32_t cpu),
