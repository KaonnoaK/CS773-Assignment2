...
TRACE_DIR1="/home/pc-04/Documents/773/pa2/trace"  #path of the first trace file (excluding the trace file name)
TRACE_DIR2="/home/pc-04/Documents/773/pa2/trace"  #path of the second trace file (excluding the trace file name)
binary=${1}
num1=${2}
num2=${3}
